...
class _ColourFormatter(logging.Formatter): # thanks to https://github.com/Rapptz/discord.py/blob/master/discord/utils.py
...
class _DiscordColorFormatter(logging.Formatter): # thanks to https://github.com/Rapptz/discord.py/blob/master/discord/utils.py
...
class Logger:
    ...
    class Linking:
        ...
        @classmethod
        def Failure(self, user: discord.User, roblox_username: str, roblox_id: int, message: str):
            self.logger.error(
    ...
    class RobloxMod:
        ...
        class GameBan:
            ...
            @classmethod
            def Success(self, admin: discord.User, roblox_username: str, roblox_id: int):
                self.logger.info(
                    f'Admin {admin} ({admin.id}) gamebanned a player ({roblox_username}, {roblox_id})'
                )
            
            @classmethod
            def Failure(self, admin: discord.User, roblox_username: str, roblox_id: int, message: str):
                self.logger.error(
    ...
    class Fun:
        class Impersonate:
            ...
            @classmethod
            def UserImpersonated(self, user: discord.User, impersonated_user: discord.Member, message: discord.WebhookMessage):
                self.logger.info(
