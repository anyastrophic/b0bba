...
from modules.loggers import _DiscordColorFormatter, _ColourFormatter, Logger, DiscordWebhookHandler
...
async def on_ready():
    ...
    bot.db = motor.motor_asyncio.AsyncIOMotorClient('mongodb://localhost:27017')[db_name]
...
if __name__ == "__main__":
    ...
    asyncio.run(
        bot.start(
            os.environ.get('B0BBA_BOT_TOKEN')
        )
    )